...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: 'screens/31_coq_session_list_now.png' });
    btns = await getButtons(page);
    console.log('COQ001 session list now:', JSON.stringify(btns));
  } catch (e) {
    console.error('ERROR:', e.message);
    await page.screenshot({ path: 'screens/ERROR_step21.png' });
  } finally {
    await browser.close();
  }
})();
