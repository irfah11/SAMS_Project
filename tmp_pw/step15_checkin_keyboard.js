...
(async () => {
  ...
  try {
    ...
    // Click on the text field canvas location to focus, then type via keyboard
    await page.mouse.click(644, 454);
    await page.waitForTimeout(500);
    await page.keyboard.type('EW5Y6I', { delay: 100 });
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'screens/19b_code_typed.png' });
    ...
    await page.screenshot({ path: 'screens/ERROR_step15.png' });
  } finally {
    await browser.close();
  }
})();
